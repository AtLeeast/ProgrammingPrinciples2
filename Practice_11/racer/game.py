...
background = pygame.image.load("Practice_11/racer/AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("Practice_11/racer/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("Practice_11/racer/Player.png")
        self.rect = self.image.get_rect()
...
pygame.mixer.Sound('Practice_11/racer/background.wav').play(-1)
# Main game loop
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound('Practice_11/racer/crash.wav').play()
        time.sleep(1)
